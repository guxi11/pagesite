...
<div class="layout" id="layout">
  <aside class="guide" id="guide">
    ...
    <div class="card">
      <div class="guide-section-title">AI Client Setup</div>
      <p>Tell your AI assistant:</p>
      <div class="guide-quote">"Configure pagest for me"</div>
      <p>It will ask for two things:</p>
      <ol>
        <li><strong>Server URL</strong> — <code id="guide-server-url"></code></li>
        <li><strong>API Key</strong> — click the "API Key" button after login to copy it</li>
      </ol>
      <div class="guide-note">Config is saved to <code>~/.pagestrc.json</code>. After that, just say "publish this page" or "share this report".</div>
    </div>

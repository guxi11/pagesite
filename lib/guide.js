...
<title>singlepage — Usage Guide</title>
...
<main>
<h1>Usage Guide</h1>
<p class="subtitle"><a href="./">&larr; Back to singlepage</a></p>
...
<h3>Install</h3>
<pre><code>npm i -g singlepage     # or use npx</code></pre>

<h3>Start a Server</h3>
<pre><code>singlepage serve --port 3000 --dir ./pages --token YOUR_ADMIN_SECRET</code></pre>
...
<h3>Upload a Page</h3>
<pre><code># plain
singlepage upload page.html --domain https://pages.example.com --api-key sp_xxx

# with encryption (access code)
singlepage upload page.html --seal --domain https://pages.example.com --api-key sp_xxx</code></pre>
<p>Output: <code>{"url":"https://...","code":"XXXX-XXXX-XXXX-XXXX"}</code></p>

<h3>Delete a Page</h3>
<pre><code>singlepage delete page_abc123.html --domain https://pages.example.com --api-key sp_xxx</code></pre>

<div class="note">
Create <code>~/.singlepagerc.json</code> with <code>{"domain":"...","apiKey":"sp_..."}</code> to skip <code>--domain/--api-key</code> every time.
</div>
</div>

<div class="card">
<h2>AI Skill <span class="badge">Claude Code</span></h2>
<p>In Claude Code (or any AI assistant with the singlepage skill), just say:</p>

<h3>Publish</h3>
<pre><code>"Share this HTML as a page"
"Publish this report to singlepage"
"Upload index.html with a seal"</code></pre>
<p>The AI writes your content to a temp file, runs <code>npx singlepage upload</code>, and returns the URL + access code.</p>

<h3>Update</h3>
<pre><code>"Update report_a1b2c3d4.html with the new version"</code></pre>

<h3>Delete</h3>
<pre><code>"Delete report_a1b2c3d4.html from singlepage"</code></pre>

<h3>First-time Setup</h3>
<p>If <code>~/.singlepagerc.json</code> is missing, the AI will walk you through:</p>
<ol>
<li>Server address (domain)</li>
<li>Register or login</li>
<li>Save config to <code>~/.singlepagerc.json</code></li>
</ol>
</div>
